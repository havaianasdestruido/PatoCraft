...
.method constructor <init>(Lcom/googleplay/licensing/Policy;Lcom/googleplay/licensing/DeviceLimiter;Lcom/googleplay/licensing/LicenseCheckerCallback;ILjava/lang/String;Ljava/lang/String;)V
    .locals 0
    .param p1, "policy"    # Lcom/googleplay/licensing/Policy;
    .param p2, "deviceLimiter"    # Lcom/googleplay/licensing/DeviceLimiter;
    .param p3, "callback"    # Lcom/googleplay/licensing/LicenseCheckerCallback;
    .param p4, "nonce"    # I
...
.method private handleResponse(ILcom/googleplay/licensing/ResponseData;)V
    ...
    invoke-interface {v0, p1}, Lcom/googleplay/licensing/LicenseCheckerCallback;->allow(I)V
    ...
    invoke-interface {v0, p1}, Lcom/googleplay/licensing/LicenseCheckerCallback;->dontAllow(I)V
...
.method public verify(Ljava/security/PublicKey;ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 93
    .local v0, "data":Lcom/googleplay/licensing/ResponseData;
    if-eqz p2, :cond_0
    ...
    const-string v6, "Invalid signed data provided."
    ...
    invoke-direct {p0, v5}, Lcom/googleplay/licensing/LicenseValidator;->handleApplicationError(I)V
    ...
    .line 136
    iget v5, v0, Lcom/googleplay/licensing/ResponseData;->responseCode:I
    ...
    :cond_3
    iget v5, v0, Lcom/googleplay/licensing/ResponseData;->nonce:I

    iget v6, p0, Lcom/googleplay/licensing/LicenseValidator;->mNonce:I
    ...
    .line 148
    :cond_4
    iget-object v5, v0, Lcom/googleplay/licensing/ResponseData;->packageName:Ljava/lang/String;

    iget-object v6, p0, Lcom/googleplay/licensing/LicenseValidator;->mPackageName:Ljava/lang/String;
    ...
    .line 154
    :cond_5
    iget-object v5, v0, Lcom/googleplay/licensing/ResponseData;->versionCode:Ljava/lang/String;

    iget-object v6, p0, Lcom/googleplay/licensing/LicenseValidator;->mVersionCode:Ljava/lang/String;
    ...
    .line 161
    :cond_6
    iget-object v4, v0, Lcom/googleplay/licensing/ResponseData;->userId:Ljava/lang/String;
    ...
    .line 172
    :sswitch_0
    iget-object v5, p0, Lcom/googleplay/licensing/LicenseValidator;->mDeviceLimiter:Lcom/googleplay/licensing/DeviceLimiter;

    invoke-interface {v5, v4}, Lcom/googleplay/licensing/DeviceLimiter;->isDeviceAllowed(Ljava/lang/String;)I

    move-result v2

    .line 173
    .local v2, "limiterResponse":I
    invoke-direct {p0, v2, v0}, Lcom/googleplay/licensing/LicenseValidator;->handleResponse(ILcom/googleplay/licensing/ResponseData;)V
    ...
    invoke-direct {p0, v5, v0}, Lcom/googleplay/licensing/LicenseValidator;->handleResponse(ILcom/googleplay/licensing/ResponseData;)V
    ...
    .line 180
    invoke-direct {p0, v7, v0}, Lcom/googleplay/licensing/LicenseValidator;->handleResponse(ILcom/googleplay/licensing/ResponseData;)V
    ...
    .line 191
    :sswitch_5
    invoke-direct {p0, v8}, Lcom/googleplay/licensing/LicenseValidator;->handleApplicationError(I)V

    goto/16 :goto_0

    .line 194
    :sswitch_6
    invoke-direct {p0, v9}, Lcom/googleplay/licensing/LicenseValidator;->handleApplicationError(I)V
