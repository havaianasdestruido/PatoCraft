...
.method public constructor <init>(Landroid/content/Context;Lcom/googleplay/licensing/Policy;Ljava/lang/String;)V
    ...
    .param p2, "policy"    # Lcom/googleplay/licensing/Policy;
    ...
    iput-object v1, p0, Lcom/googleplay/licensing/LicenseChecker;->mChecksInProgress:Ljava/util/Set;
    ...
    iput-object v1, p0, Lcom/googleplay/licensing/LicenseChecker;->mPendingChecks:Ljava/util/Queue;
    ...
    iput-object v1, p0, Lcom/googleplay/licensing/LicenseChecker;->mPublicKey:Ljava/security/PublicKey;

    .line 93
    iget-object v1, p0, Lcom/googleplay/licensing/LicenseChecker;->mContext:Landroid/content/Context;

    invoke-virtual {v1}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lcom/googleplay/licensing/LicenseChecker;->mPackageName:Ljava/lang/String;

    .line 94
    iget-object v1, p0, Lcom/googleplay/licensing/LicenseChecker;->mPackageName:Ljava/lang/String;

    invoke-static {p1, v1}, Lcom/googleplay/licensing/LicenseChecker;->getVersionCode(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lcom/googleplay/licensing/LicenseChecker;->mVersionCode:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/googleplay/licensing/LicenseChecker;->mHandler:Landroid/os/Handler;
...
.method static synthetic access$100(Lcom/googleplay/licensing/LicenseChecker;Lcom/googleplay/licensing/LicenseValidator;)V
    .locals 0
    .param p0, "x0"    # Lcom/googleplay/licensing/LicenseChecker;
    .param p1, "x1"    # Lcom/googleplay/licensing/LicenseValidator;
...
.method static synthetic access$500(Lcom/googleplay/licensing/LicenseChecker;)Ljava/security/PublicKey;
    ...
    .prologue
    .line 57
    iget-object v0, p0, Lcom/googleplay/licensing/LicenseChecker;->mPublicKey:Ljava/security/PublicKey;
...
.method private cleanupService()V
    ...
    .prologue
    .line 306
    iget-object v1, p0, Lcom/googleplay/licensing/LicenseChecker;->mService:Lcom/googleplay/licensing/ILicensingService;
    ...
    iput-object v1, p0, Lcom/googleplay/licensing/LicenseChecker;->mService:Lcom/googleplay/licensing/ILicensingService;
...
.method private declared-synchronized finishCheck(Lcom/googleplay/licensing/LicenseValidator;)V
    .locals 1
    .param p1, "validator"    # Lcom/googleplay/licensing/LicenseValidator;
...
.method private static generatePublicKey(Ljava/lang/String;)Ljava/security/PublicKey;
    ...
    .line 117
    .local v1, "e":Lcom/googleplay/util/Base64DecoderException;
    ...
    .line 119
    .end local v1    # "e":Lcom/googleplay/util/Base64DecoderException;
    :catch_2
    move-exception v1
...
.method private declared-synchronized handleServiceConnectionError(Lcom/googleplay/licensing/LicenseValidator;)V
    ...
    invoke-interface {v0, v1, v2}, Lcom/googleplay/licensing/Policy;->processServerResponse(ILcom/googleplay/licensing/ResponseData;)V
    ...
    invoke-interface {v0, v1}, Lcom/googleplay/licensing/LicenseCheckerCallback;->allow(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private runChecks()V
    ...
    .line 178
    :goto_0
    iget-object v2, p0, Lcom/googleplay/licensing/LicenseChecker;->mPendingChecks:Ljava/util/Queue;
    ...
    .local v1, "validator":Lcom/googleplay/licensing/LicenseValidator;
    if-eqz v1, :cond_0
    ...
    .line 181
    invoke-interface {v2, v4, v5, v3, v6}, Lcom/googleplay/licensing/ILicensingService;->checkLicense(JLjava/lang/String;Lcom/googleplay/licensing/ILicenseResultListener;)V
...
.method public declared-synchronized checkAccess(Lcom/googleplay/licensing/LicenseCheckerCallback;)V
    ...
    :cond_0
    :try_start_1
    new-instance v0, Lcom/googleplay/licensing/LicenseValidator;
    ...
    .line 146
    .local v0, "validator":Lcom/googleplay/licensing/LicenseValidator;
    iget-object v1, p0, Lcom/googleplay/licensing/LicenseChecker;->mService:Lcom/googleplay/licensing/ILicensingService;
    ...
    .line 153
    invoke-static {v4}, Lcom/googleplay/util/Base64;->decode(Ljava/lang/String;)[B
    ...
    .catch Lcom/googleplay/util/Base64DecoderException; {:try_start_2 .. :try_end_2} :catch_1
    ...
    :try_start_3
    invoke-interface {p1, v1}, Lcom/googleplay/licensing/LicenseCheckerCallback;->applicationError(I)V
    :try_end_3
    ...
    .line 139
    .end local v0    # "validator":Lcom/googleplay/licensing/LicenseValidator;
    ...
    .line 161
    .restart local v0    # "validator":Lcom/googleplay/licensing/LicenseValidator;
    ...
    .line 162
    invoke-direct {p0, v0}, Lcom/googleplay/licensing/LicenseChecker;->handleServiceConnectionError(Lcom/googleplay/licensing/LicenseValidator;)V
    :try_end_4
    .catch Ljava/lang/SecurityException; {:try_start_4 .. :try_end_4} :catch_0
    .catch Lcom/googleplay/util/Base64DecoderException; {:try_start_4 .. :try_end_4} :catch_1
    ...
    .line 167
    .local v8, "e":Lcom/googleplay/util/Base64DecoderException;
    :try_start_5
    invoke-virtual {v8}, Lcom/googleplay/util/Base64DecoderException;->printStackTrace()V

    goto :goto_0

    .line 170
    .end local v8    # "e":Lcom/googleplay/util/Base64DecoderException;
    :cond_2
    iget-object v1, p0, Lcom/googleplay/licensing/LicenseChecker;->mPendingChecks:Ljava/util/Queue;
