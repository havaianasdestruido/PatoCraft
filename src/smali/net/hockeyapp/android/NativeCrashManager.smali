...
.method public static createLogFile(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 7
    .param p0, "dumpTimestamp"    # Ljava/lang/String;
    ...
    const-string v6, "Dump timestamp: "
    ...
    .line 45
    .local v3, "write":Ljava/io/BufferedWriter;
    new-instance v4, Ljava/lang/StringBuilder;
    ...
    .line 55
    const-string v4, "MinidumpContainer"
    ...
    .end local v3    # "write":Ljava/io/BufferedWriter;
    :goto_0
    return-object v4
...
.method private static getFileTimestamp(Ljava/lang/String;)Ljava/lang/String;
    .locals 7
    ...
    const-string v6, "Error getting dump timestamp: "
...
.method public static handleDumpFiles(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)V
    .locals 8
    ...
    .line 24
    invoke-static {}, Lnet/hockeyapp/android/NativeCrashManager;->searchForDumpFiles()[Ljava/lang/String;
    ...
    const-string v7, "Located this dump file: "
    ...
    .line 27
    invoke-static {v0}, Lnet/hockeyapp/android/NativeCrashManager;->getFileTimestamp(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    invoke-static {v5, p2}, Lnet/hockeyapp/android/NativeCrashManager;->createLogFile(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 29
    invoke-static {p0, p1, v0, v2}, Lnet/hockeyapp/android/NativeCrashManager;->uploadDumpAndLog(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private static searchForDumpFiles()[Ljava/lang/String;
    ...
    const-string v5, "Searching for dump files in "
    ...
    :cond_0
    new-instance v2, Lnet/hockeyapp/android/NativeCrashManager$2;

    invoke-direct {v2}, Lnet/hockeyapp/android/NativeCrashManager$2;-><init>()V
...
.method public static uploadDumpAndLog(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 68
    new-instance v0, Lnet/hockeyapp/android/NativeCrashManager$1;

    invoke-direct {v0, p1, p2, p3, p0}, Lnet/hockeyapp/android/NativeCrashManager$1;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/Activity;)V

    .line 96
    invoke-virtual {v0}, Lnet/hockeyapp/android/NativeCrashManager$1;->start()V
