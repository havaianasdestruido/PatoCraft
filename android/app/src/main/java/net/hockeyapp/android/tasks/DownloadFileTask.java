...
public class DownloadFileTask extends AsyncTask<Void, Integer, Long> {
    ...
    /* JADX WARN: Code duplicated, block: B:11:0x0043 A[Catch: IOException -> 0x0047, TRY_LEAVE, TryCatch #3 {IOException -> 0x0047, blocks: (B:9:0x003e, B:11:0x0043), top: B:64:0x003e }] */
    /* JADX WARN: Code duplicated, block: B:26:0x0093 A[Catch: IOException -> 0x0097, TRY_LEAVE, TryCatch #2 {IOException -> 0x0097, blocks: (B:24:0x008e, B:26:0x0093), top: B:62:0x008e }] */
    /* JADX WARN: Code duplicated, block: B:43:0x0114 A[Catch: IOException -> 0x011b, TRY_LEAVE, TryCatch #8 {IOException -> 0x011b, blocks: (B:41:0x010f, B:43:0x0114), top: B:66:0x010f }] */
    /* JADX WARN: Code duplicated, block: B:51:0x0128 A[Catch: IOException -> 0x012c, TRY_LEAVE, TryCatch #9 {IOException -> 0x012c, blocks: (B:49:0x0123, B:51:0x0128), top: B:68:0x0123 }] */
    @Override // android.os.AsyncTask
    public Long doInBackground(Void... args) throws Throwable {
        long jValueOf;
                    ...
                    try {
                        ...
                        try {
                            ...
                            while (true) {
                                ...
                                total += (long) count;
                                publishProgress(Integer.valueOf(Math.round((total * 100.0f) / lengthOfFile)));
                                output2.write(data, 0, count);
                            }
                            output2.flush();
                            jValueOf = Long.valueOf(total);
                            if (output2 != null) {
                                try {
                                    output2.close();
                                    if (input2 != null) {
