...
public class FeedbackMessageView extends LinearLayout {
    ...
    public void setFeedbackMessage(FeedbackMessage feedbackMessage) {
        ...
        try {
            ...
            this.mDateTextView.setContentDescription(DATE_FORMAT_OUT.format(date));
        } catch (ParseException e) {
            e.printStackTrace();
        }
        this.mAuthorTextView.setText(this.mFeedbackMessage.getName());
        this.mAuthorTextView.setContentDescription(this.mFeedbackMessage.getName());
        this.mMessageTextView.setText(this.mFeedbackMessage.getText());
        this.mMessageTextView.setContentDescription(this.mFeedbackMessage.getText());
