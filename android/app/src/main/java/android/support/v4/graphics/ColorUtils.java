...
public final class ColorUtils {
    ...
    @FloatRange(from = EventEnums.SampleRate_0_percent, to = 1.0d)
    ...
    public static void XYZToLAB(@FloatRange(from = EventEnums.SampleRate_0_percent, to = XYZ_WHITE_REFERENCE_X) double x, @FloatRange(from = EventEnums.SampleRate_0_percent, to = 100.0d) double y, @FloatRange(from = EventEnums.SampleRate_0_percent, to = XYZ_WHITE_REFERENCE_Z) double z, @NonNull double[] outLab) {
        if (outLab.length != 3) {
        ...
        outLab[0] = Math.max(EventEnums.SampleRate_0_percent, (116.0d * y2) - 16.0d);
        outLab[1] = 500.0d * (x2 - y2);
        outLab[2] = 200.0d * (y2 - z2);
    }

    public static void LABToXYZ(@FloatRange(from = EventEnums.SampleRate_0_percent, to = 100.0d) double l, @FloatRange(from = -128.0d, to = 127.0d) double a, @FloatRange(from = -128.0d, to = 127.0d) double b, @NonNull double[] outXyz) {
    ...
    @ColorInt
    public static int XYZToColor(@FloatRange(from = EventEnums.SampleRate_0_percent, to = XYZ_WHITE_REFERENCE_X) double x, @FloatRange(from = EventEnums.SampleRate_0_percent, to = 100.0d) double y, @FloatRange(from = EventEnums.SampleRate_0_percent, to = XYZ_WHITE_REFERENCE_Z) double z) {
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = EventEnums.SampleRate_0_percent, to = 100.0d) double l, @FloatRange(from = -128.0d, to = 127.0d) double a, @FloatRange(from = -128.0d, to = 127.0d) double b) {
        double[] result = getTempDouble3Array();
    ...
    @ColorInt
    public static int blendARGB(@ColorInt int color1, @ColorInt int color2, @FloatRange(from = EventEnums.SampleRate_0_percent, to = 1.0d) float ratio) {
    ...
    public static void blendHSL(@NonNull float[] hsl1, @NonNull float[] hsl2, @FloatRange(from = EventEnums.SampleRate_0_percent, to = 1.0d) float ratio, @NonNull float[] outResult) {
    ...
    public static void blendLAB(@NonNull double[] lab1, @NonNull double[] lab2, @FloatRange(from = EventEnums.SampleRate_0_percent, to = 1.0d) double ratio, @NonNull double[] outResult) {
        if (outResult.length != 3) {
