    ...
    private static class Ring {
        ...
        private void drawTriangle(Canvas c, float startAngle, float sweepAngle, Rect bounds) {
            if (this.mShowArrow) {
                ...
                float x = (float) ((this.mRingCenterRadius * Math.cos(EventEnums.SampleRate_0_percent)) + ((double) bounds.exactCenterX()));
                float y = (float) ((this.mRingCenterRadius * Math.sin(EventEnums.SampleRate_0_percent)) + ((double) bounds.exactCenterY()));
        ...
        public void setInsets(int width, int height) {
            ...
            if (this.mRingCenterRadius <= EventEnums.SampleRate_0_percent || minEdge < 0.0f) {
