    ...
    public static abstract class Stub extends Binder implements ICustomTabsService {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    ICustomTabsCallback _arg5 = ICustomTabsCallback.Stub.asInterface(data.readStrongBinder());
                    boolean _result2 = newSession(_arg5);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    ICustomTabsCallback _arg6 = ICustomTabsCallback.Stub.asInterface(data.readStrongBinder());
                    if (data.readInt() != 0) {
                    ...
                    List<Bundle> _arg7 = data.createTypedArrayList(Bundle.CREATOR);
                    boolean _result3 = mayLaunchUrl(_arg6, _arg3, _arg4, _arg7);
                    reply.writeNoException();
                ...
                case 5:
                    ...
                    Bundle _result4 = extraCommand(_arg8, _arg2);
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                ...
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    ICustomTabsCallback _arg9 = ICustomTabsCallback.Stub.asInterface(data.readStrongBinder());
                    if (data.readInt() != 0) {
                        _arg1 = (Bundle) Bundle.CREATOR.createFromParcel(data);
                    } else {
                        _arg1 = null;
                    }
                    boolean _result5 = updateVisuals(_arg9, _arg1);
                    reply.writeNoException();
