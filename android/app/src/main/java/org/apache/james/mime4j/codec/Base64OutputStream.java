...
public class Base64OutputStream extends FilterOutputStream {
    ...
    private void write0(byte[] buffer, int from, int to) throws IOException {
        for (int i = from; i < to; i++) {
            ...
            if (i2 == 3) {
                ...
                this.position = i4 + 1;
                bArr2[i4] = BASE64_TABLE[(this.data >> 18) & 63];
                byte[] bArr3 = this.encoded;
                int i5 = this.position;
                this.position = i5 + 1;
                bArr3[i5] = BASE64_TABLE[(this.data >> 12) & 63];
                byte[] bArr4 = this.encoded;
                int i6 = this.position;
                this.position = i6 + 1;
                bArr4[i6] = BASE64_TABLE[(this.data >> 6) & 63];
                byte[] bArr5 = this.encoded;
                int i7 = this.position;
                this.position = i7 + 1;
                bArr5[i7] = BASE64_TABLE[this.data & 63];
                this.linePosition += 4;
            }
        }
    }
    ...
    private void writePad() throws IOException {
        ...
        if (this.modulus == 1) {
            ...
            int i = this.position;
            this.position = i + 1;
            bArr[i] = BASE64_TABLE[(this.data >> 2) & 63];
            byte[] bArr2 = this.encoded;
            int i2 = this.position;
            this.position = i2 + 1;
            bArr2[i2] = BASE64_TABLE[(this.data << 4) & 63];
            byte[] bArr3 = this.encoded;
            int i3 = this.position;
            this.position = i3 + 1;
            bArr3[i3] = BASE64_PAD;
            ...
            if (!$assertionsDisabled && this.modulus != 2) {
                throw new AssertionError();
            }
            byte[] bArr5 = this.encoded;
            int i5 = this.position;
            this.position = i5 + 1;
            bArr5[i5] = BASE64_TABLE[(this.data >> 10) & 63];
            byte[] bArr6 = this.encoded;
            int i6 = this.position;
            this.position = i6 + 1;
            bArr6[i6] = BASE64_TABLE[(this.data >> 4) & 63];
            byte[] bArr7 = this.encoded;
            int i7 = this.position;
            this.position = i7 + 1;
            bArr7[i7] = BASE64_TABLE[(this.data << 2) & 63];
