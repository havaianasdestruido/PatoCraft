...
public class StructuredFieldParserTokenManager implements StructuredFieldParserConstants {
    ...
    static final long[] jjtoMore = {PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID};
        ...
        while (true) {
            ...
            if (this.curChar < '@') {
                ...
                do {
                    ...
                    switch (this.jjstateSet[i]) {
                        case 0:
                            if ((jjbitVec0[i4] & l2) != 0 && kind > 8) {
                                kind = 8;
                            }
                            break;
                        case 1:
                            if ((jjbitVec0[i4] & l2) != 0) {
                                if (kind > 7) {
                                    kind = 7;
                                }
                                int[] iArr2 = this.jjstateSet;
