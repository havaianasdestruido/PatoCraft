...
public class GraphResponse {
    ...
    public String toString() {
        ...
        try {
            ...
            objArr[0] = Integer.valueOf(this.connection != null ? this.connection.getResponseCode() : ImageUtil.SMALL);
    ...
    static List<GraphResponse> fromHttpConnection(HttpURLConnection connection, GraphRequestBatch requests) {
        ...
        try {
            ...
            listConstructErrorResponses = constructErrorResponses(requests, connection, new FacebookException(exception2));
        } catch (JSONException exception3) {
            Logger.log(LoggingBehavior.REQUESTS, RESPONSE_LOG_TAG, "Response <Error>: %s", exception3);
            listConstructErrorResponses = constructErrorResponses(requests, connection, new FacebookException(exception3));
        } finally {
    ...
    private static List<GraphResponse> createResponsesFromObject(HttpURLConnection connection, List<GraphRequest> requests, Object object) throws JSONException, FacebookException {
        ...
        if (numRequests == 1) {
            ...
            try {
                ...
                int responseCode = connection != null ? connection.getResponseCode() : ImageUtil.SMALL;
