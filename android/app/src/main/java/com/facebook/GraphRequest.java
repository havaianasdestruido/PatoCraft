...
public class GraphRequest {
        ...
        if (this.graphObject != null) {
            ...
            processGraphObject(this.graphObject, relativeURL, new KeyValueSerializer() { // from class: com.facebook.GraphRequest.6
                ...
                public void writeString(String key2, String value2) throws IOException {
                    keysAndValues.add(String.format(Locale.US, "%s=%s", key2, URLEncoder.encode(value2, HttpURLConnectionBuilder.DEFAULT_CHARSET)));
                }
            });
    ...
    private static class Serializer implements KeyValueSerializer {
        ...
        public void write(String format, Object... args) throws IOException {
            ...
            this.outputStream.write(URLEncoder.encode(String.format(Locale.US, format, args), HttpURLConnectionBuilder.DEFAULT_CHARSET).getBytes());
        }
