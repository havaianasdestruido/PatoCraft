        ...
        try {
            if (this.mPolicy.allowAccess()) {
                ...
                if (this.mService == null) {
                    ...
                    try {
                        try {
                            boolean bindResult = this.mContext.bindService(new Intent(new String(Base64.decode("Y29tLmFuZHJvaWQudmVuZGluZy5saWNlbnNpbmcuSUxpY2Vuc2luZ1NlcnZpY2U="))).setPackage("com.android.vending"), this, 1);
                            if (bindResult) {
