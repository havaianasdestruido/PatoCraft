...
public class Cryptography {
    ...
    public static byte[] decryptWithAesCbcPcs5PaddingCipher(byte[] encryptedData, byte[] encryptionKey) throws BadPaddingException, IllegalBlockSizeException {
        Key key = new SecretKeySpec(encryptionKey, AesAlgorithm);
        IvParameterSpec iv = new IvParameterSpec(encryptedData, 0, 16);
        Cipher cipher = getInitializedDecryptionCipher(AesCbcPkcs5PaddingTransformation, key, iv);
