...
public class GetSignUpIntentOperation extends ServiceOperation {
    ...
    public Bundle call() {
        ...
        Intent signUpIntent = AddAccountActivity.getSignUpIntent(getContext(), appProperties.toBundle(), getCallingPackage(), getCallerStateBundle());
        return BundleMarshaller.pendingIntentToBundle(getPendingIntentBuilder(signUpIntent).setContext(getContext()).buildActivity());
    }
}
