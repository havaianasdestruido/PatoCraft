...
public abstract class AbstractSettings {
    ...
    protected boolean getBoolean(ISetting<? extends Boolean> setting) {
        return this._preferences.getBoolean(setting.getSettingName(), setting.getDefaultValue().booleanValue());
    }

    protected int getInt(ISetting<? extends Integer> setting) {
        return this._preferences.getInt(setting.getSettingName(), setting.getDefaultValue().intValue());
    }

    protected String getString(ISetting<? extends String> setting) {
        return this._preferences.getString(setting.getSettingName(), setting.getDefaultValue());
    }

    protected Set<String> getStringSet(ISetting<? extends Set<String>> setting) {
        return this._preferences.getStringSet(setting.getSettingName(), setting.getDefaultValue());
    }
