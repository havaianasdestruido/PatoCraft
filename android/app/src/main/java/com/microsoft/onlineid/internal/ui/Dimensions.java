...
public final class Dimensions {
    ...
    public static void ensureMinimumTouchTarget(final View view, final View parentView, final DisplayMetrics metrics) {
        parentView.post(new Runnable() { // from class: com.microsoft.onlineid.internal.ui.Dimensions.1
            ...
            public void run() {
                ...
                if (height < minimumPixels) {
                    int extraPadding2 = ((minimumPixels - height) + 1) / 2;
                    bounds.top -= extraPadding2;
                    bounds.bottom += extraPadding2;
                }
