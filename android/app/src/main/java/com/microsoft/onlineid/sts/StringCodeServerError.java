...
public class StringCodeServerError {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this._error, error._error) && this._subError == error._subError;
    }
    ...
    public String toString() {
        return String.format(Locale.US, "Server Error: %s SubError: %s", this._error, StsErrorCode.getFriendlyHRDescription(this._subError));
    }
}
