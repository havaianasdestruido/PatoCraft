...
public class InlineFlowException extends AuthenticationException {
    ...
    public String getMessage() {
        return String.format(Locale.US, "Inline flow error to be resolved at '%s': %s (code = %s, extended = %s)", this._errorUrl, this._message, this._errorCode, this._extendedErrorString);
    }
}
