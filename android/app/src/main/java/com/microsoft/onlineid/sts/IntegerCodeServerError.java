...
public class IntegerCodeServerError {
    ...
    public boolean equals(Object o) {
        ...
        return this._error == error._error && this._subError == error._subError;
    }
    ...
    public String toString() {
        return String.format(Locale.US, "Server Error: %s SubError: %s Message: %s", StsErrorCode.getFriendlyHRDescription(this._error), StsErrorCode.getFriendlyHRDescription(this._subError), this._message);
    }
}
