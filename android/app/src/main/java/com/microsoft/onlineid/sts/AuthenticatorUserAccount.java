...
public class AuthenticatorUserAccount implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this._puid, account._puid) && this._isSessionApprover == account._isSessionApprover && Objects.equals(this._username, account._username) && Objects.equals(this._token, account._token) && Arrays.equals(this._totpKey, account._totpKey);
    }
