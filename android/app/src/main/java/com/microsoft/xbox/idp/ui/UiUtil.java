...
public final class UiUtil {
    ...
    public static boolean ensureWelcomeFragment(BaseActivity activity, int fragmentId, boolean firstTime, Bundle args) {
        return firstTime ? ensureFragment(IntroducingFragment.class, activity, fragmentId, args) : ensureFragment(WelcomeFragment.class, activity, fragmentId, args);
    }
    ...
    public static boolean ensureErrorFragment(BaseActivity activity, ErrorActivity.ErrorScreen errorScreen) {
    ...
    public static boolean ensureErrorButtonsFragment(BaseActivity activity, ErrorActivity.ErrorScreen errorScreen) {
    ...
    public static boolean canScroll(ScrollView scrollView) {
        ...
        int childHeight = lp.topMargin + scrollChild.getHeight() + lp.bottomMargin;
