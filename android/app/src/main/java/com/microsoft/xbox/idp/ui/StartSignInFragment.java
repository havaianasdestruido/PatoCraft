...
public class StartSignInFragment extends BaseFragment implements ErrorHelper.ActivityContext {
    ...
    private final LoaderManager.LoaderCallbacks<StartSignInLoader.Result> startSignInCallbacks = new LoaderManager.LoaderCallbacks<StartSignInLoader.Result>() { // from class: com.microsoft.xbox.idp.ui.StartSignInFragment.1
        @Override // android.app.LoaderManager.LoaderCallbacks
        public Loader<StartSignInLoader.Result> onCreateLoader(int id, Bundle args) {
            Log.d(StartSignInFragment.TAG, "Creating LOADER_START_SIGN_IN");
            return new StartSignInLoader(StartSignInFragment.this.getActivity(), CacheUtil.getResultCache(StartSignInLoader.Result.class), args.get(ErrorHelper.KEY_RESULT_KEY));
        }
    ...
    static {
        $assertionsDisabled = !StartSignInFragment.class.desiredAssertionStatus();
        TAG = StartSignInFragment.class.getSimpleName();
        NO_OP_CALLBACKS = new Callbacks() { // from class: com.microsoft.xbox.idp.ui.StartSignInFragment.2
    ...
    private static class State implements Parcelable {
        public static final Parcelable.Creator<State> CREATOR = new Parcelable.Creator<State>() { // from class: com.microsoft.xbox.idp.ui.StartSignInFragment.State.1
