...
public class SignOutFragment extends BaseFragment implements ErrorHelper.ActivityContext {
    ...
    private final LoaderManager.LoaderCallbacks<SignOutLoader.Result> signOutCallbacks = new LoaderManager.LoaderCallbacks<SignOutLoader.Result>() { // from class: com.microsoft.xbox.idp.ui.SignOutFragment.1
