...
public class ServiceError extends Data<CommonData> {
    ...
    /* JADX WARN: Code duplicated, block: B:63:0x006b  */
    /* JADX WARN: Code duplicated, block: B:69:0x0081  */
    /* JADX WARN: Code duplicated, block: B:75:0x0097  */
    /* JADX WARN: Code duplicated, block: B:81:0x00ad  */
    protected boolean memberwiseCompareQuick(ServiceError that) {
        boolean equals;
        boolean equals2;
        boolean equals3;
        boolean equals4;
        boolean equals5 = 1 != 0 && super.memberwiseCompareQuick((Data) that);
        if (equals5) {
        ...
        boolean equals6 = equals && (this.errorName == null || this.errorName.length() == that.errorName.length());
        if (equals6) {
        ...
        boolean equals7 = equals2 && (this.errorText == null || this.errorText.length() == that.errorText.length());
        if (equals7) {
        ...
        boolean equals8 = equals3 && (this.errorCode == null || this.errorCode.length() == that.errorCode.length());
        if (equals8) {
        ...
        return equals4 && (this.pageName == null || this.pageName.length() == that.pageName.length());
    }

    protected boolean memberwiseCompareDeep(ServiceError that) {
        ...
        return equals4 && (this.pageName == null || this.pageName.equals(that.pageName));
    }
}
