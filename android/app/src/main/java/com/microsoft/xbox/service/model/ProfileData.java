...
public class ProfileData {
    ...
    public ProfileData(IUserProfileResult.UserProfileResult profileResult, boolean shareRealName) {
        this.profileResult = profileResult;
        this.shareRealName = shareRealName;
        this.shareRealNameStatus = null;
    }

    public ProfileData(IUserProfileResult.UserProfileResult profileResult, boolean shareRealName, String shareRealNameStatus, boolean sharingRealNameTransitively) {
        this.profileResult = profileResult;
        this.shareRealName = shareRealName;
