...
public class CommonData extends Base {
    ...
    /* JADX WARN: Code duplicated, block: B:171:0x0127  */
    /* JADX WARN: Code duplicated, block: B:177:0x0141  */
    /* JADX WARN: Code duplicated, block: B:183:0x015b  */
    /* JADX WARN: Code duplicated, block: B:189:0x0175  */
    /* JADX WARN: Code duplicated, block: B:195:0x018f  */
    /* JADX WARN: Code duplicated, block: B:202:0x01ac  */
    /* JADX WARN: Code duplicated, block: B:208:0x01c6  */
    /* JADX WARN: Code duplicated, block: B:214:0x01e0  */
    /* JADX WARN: Code duplicated, block: B:220:0x01fa  */
    /* JADX WARN: Code duplicated, block: B:226:0x0214  */
    /* JADX WARN: Code duplicated, block: B:232:0x022e  */
    /* JADX WARN: Code duplicated, block: B:238:0x0248  */
    protected boolean memberwiseCompareQuick(CommonData that) {
        boolean equals;
        boolean equals2;
        boolean equals3;
        boolean equals4;
        ...
        boolean equals11;
        boolean equals12;
        boolean equals13 = 1 != 0 && super.memberwiseCompareQuick((Base) that);
        if (equals13) {
            if ((this.eventVersion == null) == (that.eventVersion == null)) {
                equals = true;
            } else {
                equals = false;
            }
        ...
        boolean equals14 = equals && (this.eventVersion == null || this.eventVersion.length() == that.eventVersion.length());
        if (equals14) {
            if ((this.deviceModel == null) == (that.deviceModel == null)) {
                equals2 = true;
            } else {
                equals2 = false;
            }
        ...
        boolean equals15 = equals2 && (this.deviceModel == null || this.deviceModel.length() == that.deviceModel.length());
        if (equals15) {
            if ((this.xsapiVersion == null) == (that.xsapiVersion == null)) {
                equals3 = true;
            } else {
                equals3 = false;
            }
        ...
        boolean equals16 = equals3 && (this.xsapiVersion == null || this.xsapiVersion.length() == that.xsapiVersion.length());
        if (equals16) {
            if ((this.appName == null) == (that.appName == null)) {
                equals4 = true;
            } else {
                equals4 = false;
            }
        ...
        boolean equals17 = equals4 && (this.appName == null || this.appName.length() == that.appName.length());
        if (equals17) {
            if ((this.clientLanguage == null) == (that.clientLanguage == null)) {
                equals5 = true;
            } else {
                equals5 = false;
            }
        ...
        boolean equals18 = equals5 && (this.clientLanguage == null || this.clientLanguage.length() == that.clientLanguage.length());
        boolean equals19 = equals18 && this.network == that.network;
        if (equals19) {
        ...
        boolean equals20 = equals6 && (this.sandboxId == null || this.sandboxId.length() == that.sandboxId.length());
        if (equals20) {
            if ((this.appSessionId == null) == (that.appSessionId == null)) {
                equals7 = true;
            } else {
                equals7 = false;
            }
        ...
        boolean equals21 = equals7 && (this.appSessionId == null || this.appSessionId.length() == that.appSessionId.length());
        if (equals21) {
        ...
        boolean equals22 = equals8 && (this.userId == null || this.userId.length() == that.userId.length());
        if (equals22) {
            if ((this.additionalInfo == null) == (that.additionalInfo == null)) {
                equals9 = true;
            } else {
                equals9 = false;
            }
        ...
        boolean equals23 = equals9 && (this.additionalInfo == null || this.additionalInfo.length() == that.additionalInfo.length());
        if (equals23) {
            if ((this.accessibilityInfo == null) == (that.accessibilityInfo == null)) {
                equals10 = true;
            } else {
                equals10 = false;
            }
        ...
        boolean equals24 = equals10 && (this.accessibilityInfo == null || this.accessibilityInfo.length() == that.accessibilityInfo.length());
        if (equals24) {
            if ((this.titleDeviceId == null) == (that.titleDeviceId == null)) {
                equals11 = true;
            } else {
                equals11 = false;
            }
        ...
        boolean equals25 = equals11 && (this.titleDeviceId == null || this.titleDeviceId.length() == that.titleDeviceId.length());
        if (equals25) {
            if ((this.titleSessionId == null) == (that.titleSessionId == null)) {
                equals12 = true;
            } else {
                equals12 = false;
            }
        ...
        return equals12 && (this.titleSessionId == null || this.titleSessionId.length() == that.titleSessionId.length());
    }

    protected boolean memberwiseCompareDeep(CommonData that) {
        boolean equals = 1 != 0 && super.memberwiseCompareDeep((Base) that);
        boolean equals2 = equals && (this.eventVersion == null || this.eventVersion.equals(that.eventVersion));
        boolean equals3 = equals2 && (this.deviceModel == null || this.deviceModel.equals(that.deviceModel));
        boolean equals4 = equals3 && (this.xsapiVersion == null || this.xsapiVersion.equals(that.xsapiVersion));
        boolean equals5 = equals4 && (this.appName == null || this.appName.equals(that.appName));
        boolean equals6 = equals5 && (this.clientLanguage == null || this.clientLanguage.equals(that.clientLanguage));
        boolean equals7 = equals6 && (this.sandboxId == null || this.sandboxId.equals(that.sandboxId));
        boolean equals8 = equals7 && (this.appSessionId == null || this.appSessionId.equals(that.appSessionId));
        boolean equals9 = equals8 && (this.userId == null || this.userId.equals(that.userId));
        boolean equals10 = equals9 && (this.additionalInfo == null || this.additionalInfo.equals(that.additionalInfo));
        boolean equals11 = equals10 && (this.accessibilityInfo == null || this.accessibilityInfo.equals(that.accessibilityInfo));
        boolean equals12 = equals11 && (this.titleDeviceId == null || this.titleDeviceId.equals(that.titleDeviceId));
        return equals12 && (this.titleSessionId == null || this.titleSessionId.equals(that.titleSessionId));
    }
}
