...
public interface zzb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzb {
        ...
        private static class C0005zza implements zzb {
        ...
        public static zzb zzcd(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzb)) ? new C0005zza(iBinder) : (zzb) iInterfaceQueryLocalInterface;
        }
