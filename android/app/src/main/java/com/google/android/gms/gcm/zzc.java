...
public interface zzc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzc {
        ...
        private static class C0004zza implements zzc {
        ...
        public static zzc zzbZ(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzc)) ? new C0004zza(iBinder) : (zzc) iInterfaceQueryLocalInterface;
        }
