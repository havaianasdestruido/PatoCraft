...
import quack.mc.patocraft.MainActivity;
...
public class MeasurementEvent {
    ...
    private static Bundle getApplinkLogData(Context context, String eventName, Bundle appLinkData, Intent applinkIntent) {
        ...
        if (resolvedActivity != null) {
            logData.putString(Name.LABEL, resolvedActivity.getShortClassName());
        }
        if (APP_LINK_NAVIGATE_OUT_EVENT_NAME.equals(eventName)) {
            if (resolvedActivity != null) {
                logData.putString(MainActivity.PACKAGE_NAME_KEY, resolvedActivity.getPackageName());
            }
            ...
            if (o instanceof Bundle) {
                for (String subKey : ((Bundle) o).keySet()) {
                    ...
                    if (key.equals("referer_app_link")) {
                        ...
                        } else if (subKey.equalsIgnoreCase(MainActivity.PACKAGE_NAME_KEY)) {
